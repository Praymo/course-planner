...
我后来也接受了一个很现实的边界：「在沙盘里排好，然后直接选上」其实等于重做一遍 SIS 的选课流程。数据、接口和授权都在学校手里，学生身份拿不到，不是再熬几个晚上写代码就能补出来的。既然这部分暂时做不了，就把力气放回不需要任何权限的规划层，至少让它值得大家在正式选课前专门打开一次。

因此，沙盘可以降低反复登录系统比较方案的成本，但不能绕过内网要求，也不能替代正式选课。

## 同学们用过以后说了什么

我把第一版发给同班同学以后，也在微信上问过大家还缺什么。几个人提到的东西很接近，都是选课时很想知道、学校系统里又找不到的信息：

- 学过的人怎么看这门课，比如工作量大不大、老师怎么上课、适合什么基础；
- 这学期具体怎么计分，期中、期末、作业和展示各占多少；
- 还有一些大家做决定时会 care、但现在只能到处打听的小信息。

这让我更确定，下一步不必急着塞进更多按钮，应该先把课程本身说清楚。下面路线图里的「补考核构成」和「加入选课经验」，就是从这些反馈里来的。

我没有统计人数，也没有把微信截图放进仓库，更不想把几条聊天包装成一份很正式的“用户研究”。它们只能说明方向值得继续试，不能证明所有同学都有同样的需要。

还有同学提过，能不能顺便在沙盘里找课程作业的队友。这个需求是真的，但我最后没有加。组队要处理身份、实时协作和彼此信任，已经是另一个产品了；硬塞进来，反而会让「选课前把方案排明白」这件事变得模糊。先把排课和课程信息做好，之后再看有没有必要往外长。
...
这里还有个有点尴尬的冷启动问题：评分标准通常藏在课程 PPT 或当期大纲里，往往只有已经选上这门课的人才拿得到。可最需要这些信息的时候，偏偏是选课之前。

所以一开始只能慢慢积累：先整理我自己上过、手里还留着材料的课程，再请愿意分享的同学补充当期资料。覆盖不会一下子很完整，拿不到就明确留空；往届信息可以作为参考，但不能冒充这学期的考核标准。
...
## 本地打开与检查
可以直接点开的域名：https://thunderous-gingersnap-3d617d.netlify.app/
